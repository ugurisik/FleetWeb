...
$type = $params['type'];
if ($type == "list") {
    $bread_title = "Kaza Listesi";
} else if ($type == "show") {
    $bread_title = "Kaza Göster";
}
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h5 class="card-title mb-0">Kazalar</h5>
                        </div>
                        <div class="card-body">
                            <table id="carList" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><span class="badge bg-info">750€</span></td>
                                        <td class="text-end">
                                            <a href="crash.php?type=show" class="btn btn-outline-info text-center m-1"><i class="ri-eye-fill align-bottom fs-16"></i></a>
                                ...
                                <div class="col-xl-12 col-lg-12">
                                            ...
                                            <div class="text-muted">
                                                ...
                                                <div class="pt-3 border-top border-top-dashed mt-4">
                                                    <div class="row gy-3">
                                                        ...
                                                        <div class="col-lg-4 col-sm-6">
                                                            <div>
                                                                <p class="mb-2 text-uppercase fw-medium">Hatalı Taraf</p>
                                                                <h5 class="fs-15 mb-0">Karşı Taraf</h5>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4 col-sm-6">
                                                            <div>
                                                                <p class="mb-2 text-uppercase fw-medium">Kaza</p>
                                                                <h5 class="fs-15 mb-0">Çarpışma</h5>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4 col-sm-6">
                                                            <div>
                                                                <p class="mb-2 text-uppercase fw-medium">Kaza Tarihi</p>
                                                        ...
                                                        <div class="col-lg-4 col-sm-6">
                                                            <div>
                                                                ...
                                                                <h5 class="fs-15 mb-0">750€</h5>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12 col-sm-6">
                                                            <div>
                                                                <p class="mb-2 text-uppercase fw-medium">Açıklama</p>
                                                                <h5 class="fs-15 mb-0">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptates nemo exercitationem officiis debitis sapiente inventore quas quod error tempore qui ex, pariatur accusamus necessitatibus quasi consequatur saepe maiores dicta id! Debitis nihil aliquid nesciunt, laboriosam excepturi aliquam temporibus incidunt in aperiam molestias suscipit, error eaque non officia ipsam numquam est.</h5>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title mb-0">Kaza Görselleri</h4>
                                        </div><!-- end card header -->
                                        <div class="card-body">
                                            <div class="swiper pagination-custom-swiper rounded">
                                                <div class="swiper-wrapper">
                                                    ...
                                                    <div class="swiper-slide">
                                                        <img src="<?= ASSET_PATH ?>/images/small/img-3.jpg" alt="" class="img-fluid" />
                                                    </div>
                                                    <div class="swiper-slide">
                                                        <img src="<?= ASSET_PATH ?>/images/small/img-4.jpg" alt="" class="img-fluid" />
                                                    </div>
                                                </div>
