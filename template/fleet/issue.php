...
$type = $params['type'];
if ($type == "list") {
    $bread_title = "Sorun Listesi";
} else if ($type == "show") {
    $bread_title = "Sorun Göster";
}
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h5 class="card-title mb-0">Sorunlar</h5>
                        </div>
                        <div class="card-body">
                            <table id="carList" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="issue.php?type=show" class="btn btn-outline-info text-center m-1"><i class="ri-eye-fill align-bottom fs-16"></i></a>
                                ...
                                <div class="col-xl-12 col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="text-muted">
                                                <h6 class="mb-3 fw-semibold text-uppercase">Sorun</h6>
                                                ...
                                                <div class="pt-3 border-top border-top-dashed mt-4">
                                                    <div class="row gy-3">
                                                        ...
                                                        <div class="col-lg-4 col-sm-6">
                                                            <div>
                                                                <p class="mb-2 text-uppercase fw-medium">Sorun</p>
                                                                <h5 class="fs-15 mb-0">Park Lambası Çalışmıyor</h5>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4 col-sm-6">
                                                            <div>
                                                                <p class="mb-2 text-uppercase fw-medium">Sorun Tarihi</p>
                                                        ...
                                                        <div class="col-lg-12 col-sm-12">
                                                            <div>
                                                                ...
                                                                <h5 class="fs-15 mb-0">Aldığımda böyleydi</h5>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title mb-0">Sorun Görseli</h4>
                                        </div><!-- end card header -->
                                        <div class="card-body">
