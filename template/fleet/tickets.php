...
$type = $params['type'];
if ($type == "list") {
    $bread_title = "Ceza Listesi";
} else if ($type == "show") {
    $bread_title = "Ceza Göster";
}
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h5 class="card-title mb-0">Cezalar</h5>
                        </div>
                        <div class="card-body">
                            <table id="carList" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="tickets.php?type=show" class="btn btn-outline-info text-center m-1"><i class="ri-eye-fill align-bottom fs-16"></i></a>
                                ...
                                <div class="col-xl-12 col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="text-muted">
                                                <h6 class="mb-3 fw-semibold text-uppercase">Ceza</h6>
                                                    ...
                                                    <div class="row gy-3">
                                                        ...
                                                        <div class="col-lg-4 col-sm-6">
                                                            <div>
                                                                ...
                                                                <h5 class="fs-15 mb-0">Ödenmedi</h5>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4 col-sm-6">
                                                            <div>
                                                                <p class="mb-2 text-uppercase fw-medium">Ceza</p>
                                                                <h5 class="fs-15 mb-0">Park Cezası</h5>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4 col-sm-6">
                                                            <div>
                                                        ...
                                                        <div class="col-lg-4 col-sm-6">
                                                            <div>
                                                                <p class="mb-2 text-uppercase fw-medium">Ceza Tarihi</p>
                                                        ...
                                                        <div class="col-lg-12 col-sm-12">
                                                            <div>
                                                                ...
                                                                <h5 class="fs-15 mb-0">Sahabiye otopark girişine, geçişi engellemeyecek şekilde park edilmesine rağmen savcı tarafından keyfi ceza alındı!</h5>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title mb-0">Ceza Tutanağı</h4>
                                        </div><!-- end card header -->
                                        <div class="card-body">
